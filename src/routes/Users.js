...
const { createUser, createAdminUser, userLogin, resetPasswordUser } = require("../validations/Users");
...
router.route("/reset-password").post(validate(resetPasswordUser), resetPassword);
